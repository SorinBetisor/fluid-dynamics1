...
// OpenMP parallelized version of Euler time-advancement
void euler_parallel(mtrx w, mtrx dwdx, mtrx dwdy, mtrx d2wdx2, mtrx d2wdy2, mtrx u, mtrx v, double Re, double dt)
{
    int i, j;
